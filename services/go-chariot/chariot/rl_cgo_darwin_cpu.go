...
/*
#cgo CFLAGS: -I${SRCDIR}/../knapsack-library/lib/macos-cpu
#cgo LDFLAGS: ${SRCDIR}/../knapsack-library/lib/macos-cpu/librl_support.a -L/opt/homebrew/lib -lonnxruntime -lc++ -lm
...
// rlInit_impl is the macOS CPU implementation of rlInit
...
// rlScore_impl is the macOS CPU implementation of rlScore
...
// rlLearn_impl is the macOS CPU implementation of rlLearn
...
// rlClose_impl is the macOS CPU implementation of rlClose
