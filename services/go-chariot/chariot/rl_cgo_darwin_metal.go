...
#cgo LDFLAGS: ${SRCDIR}/../knapsack-library/lib/macos-metal/librl_support.a -L/opt/homebrew/lib -lonnxruntime -lc++ -lm -framework Metal -framework Foundation
...
// rlInit_impl is the macOS Metal implementation of rlInit
// It wraps rl_init_from_json from librl_support.a (Metal-accelerated)
...
// rlScore_impl is the macOS Metal implementation of rlScore
...
// rlLearn_impl is the macOS Metal implementation of rlLearn
...
// rlClose_impl is the macOS Metal implementation of rlClose
