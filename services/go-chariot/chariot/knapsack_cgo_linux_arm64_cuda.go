...
#cgo CXXFLAGS: -I${SRCDIR}/../knapsack-library/lib/linux-cuda -std=c++14
#cgo LDFLAGS: -Wl,--start-group ${SRCDIR}/../knapsack-library/lib/linux-cuda/libknapsack_cuda.a -lstdc++ -Wl,--end-group -lm -lcudart
...
// SolveKnapsack is the V2 entry point for Linux ARM64 with CUDA GPU acceleration.
// It wraps the C API from libknapsack_cuda.a built with NVIDIA CUDA support.
//
