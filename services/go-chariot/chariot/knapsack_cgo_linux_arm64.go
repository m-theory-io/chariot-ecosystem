...
#cgo CXXFLAGS: -I${SRCDIR}/../knapsack-library/lib/linux-arm64 -std=c++14
#cgo LDFLAGS: -Wl,--start-group ${SRCDIR}/../knapsack-library/lib/linux-arm64/libknapsack_linux_arm64.a -lstdc++ -Wl,--end-group -lm

#include <stdlib.h>
#include "knapsack_linux_arm64.h"
*/
import "C"
import (
	"errors"
...
// SolveKnapsack is the V2 entry point for Linux ARM64 (CPU-only).
// It wraps the C API from libknapsack_linux_arm64.a built without GPU support.
//
