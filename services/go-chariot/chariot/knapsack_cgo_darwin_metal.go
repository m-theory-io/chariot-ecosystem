...
// SolveKnapsack is the V2 entry point for macOS with Metal GPU acceleration.
// It wraps the C API from libknapsack_metal.a built with Metal GPU support.
//
