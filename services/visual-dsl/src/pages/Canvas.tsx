...
export default function VisualDSLPrototype() {
  ...
  const openPropertiesDialog = React.useCallback((nodeId: string) => {
    ...
    if (node) {
      ...
      if ((label === 'Start' || label === 'start') && category === 'control') {
        ...
        nodeType = 'create';
      } else if ((label === 'parseJSON' || label === 'Parse JSON') && category === 'json') {
        nodeType = 'parseJSON';
      } else if ((label === 'parseJSONSimple' || label === 'Parse JSON Simple') && category === 'json') {
        nodeType = 'parseJSONSimple';
      } else if ((label === 'toJSON' || label === 'To JSON') && category === 'json') {
        nodeType = 'toJSON';
      ...
      } else if ((label === 'Exists' || label === 'exists') && category === 'value') {
        nodeType = 'exists';
      } else if ((label === 'Type Of' || label === 'typeOf') && category === 'value') {
        nodeType = 'typeOf';
  ...
  const addLogiconRandom = (logicon: LogiconData, withModifier: boolean = false) => {
    ...
    } else if (logicon.label === 'parseJSON') {
      defaultProperties = {
  ...
  <div className="flex-1 bg-gray-100 dark:bg-gray-900 relative overflow-hidden">
          ...
          {propertiesDialog && propertiesDialog.nodeType === 'parseJSONSimple' && (
            <ParseJSONSimpleNodePropertiesDialog
              isOpen={true}
              onClose={() => setPropertiesDialog(null)}
              onSave={(properties) => saveNodeProperties(propertiesDialog.nodeId, properties)}
              onDelete={() => {
              ...
              initialProperties={propertiesDialog.properties as ParseJSONSimpleNodeProperties || { 
                jsonString: '{"key": "value"}'
              }}
            />
          )}
          
          {propertiesDialog && propertiesDialog.nodeType === 'toJSON' && (
            <ToJSONNodePropertiesDialog
              isOpen={true}
              onClose={() => setPropertiesDialog(null)}
              onSave={(properties) => saveNodeProperties(propertiesDialog.nodeId, properties)}
              onDelete={() => {
              ...
              initialProperties={propertiesDialog.properties as ToJSONNodeProperties || { 
                value: 'myValue'
              }}
            />
          )}
          
          {propertiesDialog && propertiesDialog.nodeType === 'toSimpleJSON' && (
            <ToSimpleJSONNodePropertiesDialog
              isOpen={true}
              onClose={() => setPropertiesDialog(null)}
              onSave={(properties) => saveNodeProperties(propertiesDialog.nodeId, properties)}
              onDelete={() => {
          ...
          {propertiesDialog && propertiesDialog.nodeType === 'exists' && (
            <ExistsNodePropertiesDialog
              isOpen={true}
              onClose={() => setPropertiesDialog(null)}
              onSave={(properties) => saveNodeProperties(propertiesDialog.nodeId, properties)}
              onDelete={() => {
              ...
              initialProperties={propertiesDialog.properties as ExistsNodeProperties || { 
                variableName: 'myVar'
              }}
            />
          )}
          
          {propertiesDialog && propertiesDialog.nodeType === 'typeOf' && (
            <TypeOfNodePropertiesDialog
              isOpen={true}
              onClose={() => setPropertiesDialog(null)}
              onSave={(properties) => saveNodeProperties(propertiesDialog.nodeId, properties)}
              onDelete={() => {
              ...
              initialProperties={propertiesDialog.properties as TypeOfNodeProperties || { 
                value: 'myVar'
              }}
            />
          )}
          
          {propertiesDialog && propertiesDialog.nodeType === 'valueOf' && (
            <ValueOfNodePropertiesDialog
              isOpen={true}
              onClose={() => setPropertiesDialog(null)}
              onSave={(properties) => saveNodeProperties(propertiesDialog.nodeId, properties)}
              onDelete={() => {
              ...
              initialProperties={propertiesDialog.properties as ValueOfNodeProperties || { 
                value: 'myVar',
                targetType: ''
              }}
            />
