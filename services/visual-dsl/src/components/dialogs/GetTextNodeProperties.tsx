...
interface GetTextNodePropertiesProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (properties: GetTextNodeProperties) => void;
  onDelete: () => void;
  initialProperties: GetTextNodeProperties;
}

export interface GetTextNodeProperties {
  node: string; // variable name of the XML node to get text from
}

export const GetTextNodePropertiesDialog: React.FC<GetTextNodePropertiesProps> = ({
  isOpen,
  onClose,
  onSave,
  onDelete,
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
              Variable holding the XML node whose text content you want to read.
            </p>
          </div>
