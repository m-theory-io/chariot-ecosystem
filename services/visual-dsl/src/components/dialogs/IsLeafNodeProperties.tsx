...
interface IsLeafNodePropertiesProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (properties: IsLeafNodeProperties) => void;
  onDelete: () => void;
  initialProperties: IsLeafNodeProperties;
}

export interface IsLeafNodeProperties {
  node: string; // variable name of the node to check
}

export const IsLeafNodePropertiesDialog: React.FC<IsLeafNodePropertiesProps> = ({
  isOpen,
  onClose,
  onSave,
  onDelete,
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
              The variable of the node to check if it is a leaf (no children).
            </p>
          </div>
