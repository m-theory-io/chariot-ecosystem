...
interface GetNameNodePropertiesProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (properties: GetNameNodeProperties) => void;
  onDelete: () => void;
  initialProperties: GetNameNodeProperties;
}

export interface GetNameNodeProperties {
  node: string; // variable name of the node to get name for
}

export const GetNameNodePropertiesDialog: React.FC<GetNameNodePropertiesProps> = ({
  isOpen,
  onClose,
  onSave,
  onDelete,
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
              The variable of the node to get the name from.
            </p>
          </div>
