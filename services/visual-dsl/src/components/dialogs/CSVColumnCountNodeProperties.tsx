...
interface CSVColumnCountNodePropertiesProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (properties: CSVColumnCountNodeProperties) => void;
  onDelete: () => void;
  initialProperties: CSVColumnCountNodeProperties;
}

export interface CSVColumnCountNodeProperties {
  nodeOrPath: string;
}

export const CSVColumnCountNodePropertiesDialog: React.FC<CSVColumnCountNodePropertiesProps> = ({
  isOpen,
  onClose,
  onSave,
  onDelete,
