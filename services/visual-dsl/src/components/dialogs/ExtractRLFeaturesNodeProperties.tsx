...
export interface ExtractRLFeaturesNodeProperties {
  candidates: string;
  mode: string;
}

interface ExtractRLFeaturesNodePropertiesProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (properties: ExtractRLFeaturesNodeProperties) => void;
  onDelete: () => void;
  initialProperties: ExtractRLFeaturesNodeProperties;
}

export const ExtractRLFeaturesNodePropertiesDialog: React.FC<ExtractRLFeaturesNodePropertiesProps> = ({
  isOpen,
  onClose,
  onSave,
  onDelete,
  ...
  const [mode, setMode] = React.useState(initialProperties.mode || 'normalized');
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg border-2 border-gray-800 dark:border-gray-200 shadow-xl max-w-md w-full mx-4">
        ...
        <div className="bg-gray-100 dark:bg-gray-700 px-4 py-2 border-b border-gray-800 dark:border-gray-200 flex justify-between items-center">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">
            Extract RL Features Properties
          </h3>
          <button
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
              numeric: raw values, normalized: scaled to [0, 1]
            </p>
          </div>
