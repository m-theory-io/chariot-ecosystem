...
export interface CaseNodeProperties {
  name?: string;
  condition?: string;
  description?: string;
  body?: string;
...
interface CaseNodePropertiesDialogProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (properties: CaseNodeProperties) => void;
  initialProperties?: CaseNodeProperties;
}

const defaultState: CaseNodeProperties = {
  name: '',
  condition: '',
  description: '',
  body: ''
...
export const CaseNodePropertiesDialog: React.FC<CaseNodePropertiesDialogProps> = ({
  isOpen,
  onClose,
  onSave,
  initialProperties = {}
}) => {
  const [properties, setProperties] = useState<CaseNodeProperties>({
    ...defaultState,
    ...initialProperties
  });
  ...
  const handleSave = () => {
    onSave({
      ...
      condition: properties.condition?.trim() || '',
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Input
              ...
              placeholder="e.g., equal(value, 'active')"
            />
          </div>
          ...
          <div>
            ...
            <Input
              ...
              placeholder="Describe when this case should run"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Statements to execute inside this case block"
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
              Paste the statements that should appear inside the case braces.
            </p>
          </div>
        </div>
...
export default CaseNodePropertiesDialog;
